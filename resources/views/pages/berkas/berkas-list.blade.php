...
<div class="col">
	...
	{{-- // --}}
	{{-- Modal Add --}}
	@include('pages.berkas.popup.create')
    {{-- Modal Edit --}}
    @include('pages.berkas.popup.edit')
	{{-- Modal Delete --}}
	@include('pages.berkas.popup.delete')
</div>
@endsection
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if ((data.errors)) {
                    ...
                    var data_berkas = '<tr class="item'+data.id+'">'
                                       ...
                                       +'</td'
                                   +'</tr>';
                    $('.item' + data.id).replaceWith(data_berkas);
                    setTimeout(function(){
                       window.location.reload(1);
                    }, 5000);
