    ...
    <div class="tab-content" id="nav-tabContent">
	      ...
	      <div class="card border-light mb-3">
	      	<div class="card-body">
			   ...
			   <div class="collapse" id="colaps-gambar">
                <img class="current-picture img-thumbnail img-responsive" src="{{ asset(Auth::user()->profile_picture) }}" alt="Profile picture" />
            	</div>
            </div>
          </div>
  	  </div>
				...
				<div class="col-md-12">
					<form role="form" method="POST" action="{{ route('profile-update',Auth::user()->id) }}" enctype="multipart/form-data">
					  ...
					  <div class="form-group">
					    ...
					    <input type="text" class="form-control" name="full_name" id="full_name" value="{{ Auth::user()->full_name }}" placeholder="Nama Lengkap">
					  </div>
					  <div class="form-group">
      ...
      <div class="col-6">
	      <div class="card border-light mb-3">
	      	<div class="card-body">
				<div class="col-md-12">
					<form role="form" method="POST" action="{{ route('setting-update',Auth::user()->id ) }}" enctype="multipart/form-data">
					   {{ csrf_field() }}
					  <div class="form-group">
					    <label for="">Nama</label>
					    <input type="text" class="form-control" id="nama" name="nama" placeholder="Masukkan nama" value="{{ Auth::user()->nama }}">
					  </div>
					  <div class="form-group">
					    <label for="">Email</label>
					    <input type="email" class="form-control" id="email" name="email" aria-describedby="emailHelp" placeholder="Masukkan email" value="{{ Auth::user()->email }}">
					  </div>
					  <div class="form-group">
					    <label for="">Telephon</label>
					    <input type="text" class="form-control" id="tlp" name="tlp" placeholder="Masukkan Telephon" value="{{ Auth::user()->tlp }}">
					  </div>
