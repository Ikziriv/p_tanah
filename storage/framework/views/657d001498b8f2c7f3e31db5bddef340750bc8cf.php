	      ...
	      <div class="card border-light mb-3">
            <div class="card-header">
                <div class="clearfix">
                    ...
                    <a href="<?php echo e(route('user-create')); ?>" class="btn btn-dark btn-sm text-sm-center text-white float-right active">
                    Tambah
                    </a>
                </div>
            </div>
		      		...
		      		<table class="table table-hover table-sm text-center" id="users">
		            	...
		            	<tbody>
		            		...
		            		<tr class="item<?php echo e($user->id); ?>">
		            			...
		            			<td><?php echo e($user->tlp); ?></td>
		            			<td><?php echo e($user->email); ?></td>
		            			<td>
		            				<div class="btn-group" role="group" aria-label="Basic example">
                                      <a href="<?php echo e(route('user-edit', $user->id)); ?>" class="btn btn-sm btn-outline-dark edit-modal">
                                        Ubah
                                      </a>
									  <button type="button" class="btn btn-sm btn-outline-dark delete-modal" href="#"
									    	data-id="<?php echo e($user->id); ?>" 
									    	data-nama="<?php echo e($user->nama); ?>">Hapus</button>
									</div>
		            			</td>
		            		</tr>
...
<?php echo $__env->make('pages.user.popup.delete', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
