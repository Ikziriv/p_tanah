...
<div class="col">
    <ul class="nav nav-tabs small" role="tablist">
	  <li class="nav-item">
	    <a class="nav-link text-uppercase active" href="<?php echo e(route('master-berkas-index')); ?>">
	    	Kembali
	    </a>
	  </li>
    </ul>
                  ...
                  <div class="col-12">
                       <div class="table-responsive">
                         ...
                         <table class="table table-bordered table-striped" id="user_table">
                           ...
                           <tbody>
                            <?php $__currentLoopData = $berkas_d; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                              <td><input type="text" name="nama_hub[]" value="<?php echo e($v->nama_hub); ?>" class="form-control form-control-sm" /></td>
                              <td><input type="text" name="tgl_umur[]" value="<?php echo e($v->tgl_umur); ?>" class="form-control form-control-sm" /></td>
                              <td><input type="text" name="hubungan[]" value="<?php echo e($v->hubungan); ?>" class="form-control form-control-sm" /></td>
                              <td><input type="text" name="alamat[]" value="<?php echo e($v->alamat); ?>" class="form-control form-control-sm" /></td>
...
$(document).ready(function(){
    ...
    $('.option').on('click', '.simpan', function(event) {
        ...
        $.ajax({
            type: 'POST',
            url:'<?php echo e(route("simpan-master-berkas")); ?>',
            dataType: 'json',
