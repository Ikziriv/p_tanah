      ...
      <div class="col-12">
        ...
        <form role="form">
          <div class="form-group">
            ...
            <input type="hidden" name="id" id="edit_id" value="<?php echo e($user->id); ?>">
            <input type="text" class="form-control error_nama" id="edit_nama" value="<?php echo e($user->nama); ?>" name="nama">
          <div class="invalid-name">
          </div>
          </div>
          <div class="form-group">
            <label for="username">Username</label>
            <input type="text" class="form-control error_username" id="edit_username" <?php echo e($user->username); ?> name="username">
          <div class="invalid-username">
          </div>
          </div>
          <div class="form-group">
            <label for="email">Email</label>
            <input type="email" class="form-control error_email" id="edit_email" value="<?php echo e($user->email); ?>" name="email">
          <div class="invalid-email">
          </div>
          </div>
          <div class="form-group">
            <label for="tlp">Telephone</label>
            <input type="number" class="form-control error_tlp" id="edit_tlp" value="<?php echo e($user->tlp); ?>" name="tlp">
