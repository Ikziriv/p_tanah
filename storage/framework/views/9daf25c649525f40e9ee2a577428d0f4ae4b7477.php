...
<div class="col">
	      	...
	      	<div class="card-body">
		      	<div class="table-responsive justify-content-center">
		      		<table class="table table-hover table-sm text-center" id="sppt" cellspacing="0" width="100%"
		            	...
		            	<tbody>
		            		<?php $__currentLoopData = $sppt; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="item<?php echo e($s->id); ?>">
                                <td class="col1"><?php echo e($key+1); ?></td>
		            			<td><?php echo e($s->kode); ?></td>
                                <td>
                                    <div class="btn-group" role="group">
                                      <button class="btn btn-sm btn-outline-dark edit-modal" 
                                                data-id="<?php echo e($s->id); ?>"
                                                data-kode="<?php echo e($s->kode); ?>">
                                        Ubah
                                      </button>
	...
	<?php echo $__env->make('pages.sppt.popup.create', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    
    <?php echo $__env->make('pages.sppt.popup.edit', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
	
	<?php echo $__env->make('pages.sppt.popup.delete', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
</div>
<?php $__env->stopSection(); ?>
