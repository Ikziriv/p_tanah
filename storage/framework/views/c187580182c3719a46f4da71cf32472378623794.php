...
<div class="col">
    <ul class="nav nav-tabs small" role="tablist">
        <li class="nav-item"><a class="nav-link text-uppercase active" href="<?php echo e(route('tanah-index')); ?>">Beranda</a></li>
    </ul>
    ...
    <div class="tab-content" id="nav-tabContent">
      ...
      <div class="col-md-6">
        <div class="btn-group pull-right" role="group" aria-label="Basic example">
          <a href="<?php echo e(route('tanah-detail', $data->id)); ?>" class="btn btn-sm btn-outline-dark pull-right">
            Lihat Data
          </a>
          ...
          <form class="container text-center" method="PUT" role="form">
            ...
            <div class="form-row">
              <div class="form-group col-md-4">
                <label class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input"   
                        value="<?php echo e($data->ktp_penjual); ?>" 
              ...
              <div class="form-group col-md-4">
                <label class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input"    
                        value="<?php echo e($data->ktp_lain); ?>" 
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-4">
                <label class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input"    
                        value="<?php echo e($data->s_sengketa); ?>" 
              ...
              <div class="form-group col-md-4">
                <label class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input"    
                        value="<?php echo e($data->s_riwayat_tanah); ?>" 
            ...
            <div class="form-row">
              <div class="form-group col-md-4">
                <label class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input"    
                        value="<?php echo e($data->s_persetujuan); ?>" 
              ...
              <div class="form-group col-md-4">
                <label class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input"    
                        value="<?php echo e($data->s_ket_menikah); ?>" 
              ...
              <div class="form-group col-md-4">
                <label class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input"    
                        value="<?php echo e($data->buku_nikah); ?>" 
            ...
            <div class="form-row">
              <div class="form-group col-md-4">
                <label class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input"    
                        value="<?php echo e($data->s_beda_nama); ?>" 
              ...
              <div class="form-group col-md-4">
                <label class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input"    
                        value="<?php echo e($data->s_beda_luas); ?>" 
              ...
              <div class="form-group col-md-4">
                <label class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input"    
                        value="<?php echo e($data->s_kematian); ?>" 
            ...
            <div class="form-row">
              <div class="form-group col-md-4">
                <label class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input"    
                        value="<?php echo e($data->s_ahli_waris); ?>" 
              ...
              <div class="form-group col-md-4">
                <label class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input"    
                        value="<?php echo e($data->s_kuasa_waris); ?>" 
              ...
              <div class="form-group col-md-4">
                <label class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input"    
                        value="<?php echo e($data->ktp_ahli_waris); ?>" 
            ...
            <div class="form-row">
              <div class="form-group col-md-4">
                <label class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input"    
                        value="<?php echo e($data->kk_ahli_waris); ?>" 
              ...
              <div class="form-group col-md-4">
                <label class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input"    
                        value="<?php echo e($data->s_girik_hilang); ?>" 
              ...
              <div class="form-group col-md-4">
                <label class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input"    
                        value="<?php echo e($data->letter_c); ?>" 
            ...
            <div class="form-row">
              <div class="form-group col-md-4">
                <label class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input"    
                        value="<?php echo e($data->foto_transaksi); ?>" 
              ...
              <div class="form-group col-md-4">
                <label class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input"    
                        value="<?php echo e($data->kwitansi_pembayaran); ?>" 
              ...
              <div class="form-group col-md-4">
                <label class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input"    
                        value="<?php echo e($data->gambar_situasi); ?>" 
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-4">
                <label class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input"    
                        value="<?php echo e($data->s_pengakuan_tanah); ?>" 
              ...
              <div class="form-group col-md-4">
                <label class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input"    
                        value="<?php echo e($data->s_kesepakatan_bersama); ?>" 
